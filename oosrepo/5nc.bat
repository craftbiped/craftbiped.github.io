...
echo.    Страны, приходяшие с любой страной на букву У: Литва, Латвия, Эстония, Япония, Азербайджан, Грузия, Германия, Финляндия
...
echo.    БОНУСНАЯ НОЧЬ...
echo.    Сложность: СЛОЖНО
echo.    Страны, КОТОРЫЕ ОТДАЮТ ВАС УКРАИНЕ: Литва, Латвия, Эстония, Япония, Азербайджан, Грузия, Германия, Финляндия, Микронезия, Польша
