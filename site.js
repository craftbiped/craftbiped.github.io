...
<nav>  
   <ul class="topmenu">
    ...
    <li><a onclick="go('/donate')">Получить донат</a></li>
...
<div id="Firefox"></div>
            ...
            <li><a class="menu-item" href="#" onclick="go('/donate')">Получить донат</a></li>
...
<p><a onclick="go('/donate')" class=\"bottom-element\">Получить привилегию</a></p> 
...
<br>
<h2>Ссылки</h2>
<p> Discord: <br><a href="/dsinapp">http://craftbiped.github.io/ds</a></p>
<br><br>
...
`
  ...
  if (path == "/donate" || path == "/donate.html"){
        var nonf = "no";
    document.title = "Получение привилегий/кейсов - CraftBiped";
   var pageinfo = document.getElementById("pageinfo");
   pageinfo.innerHTML = "Получение привилегий/кейсов";
...
<br><br><br><br><br><br>
<center>
<h2>Как получить привилегию или донат кейс на нашем сервере?</h2>
<p>Начиная с 22 января 2025 года у нас снова бесплатный донат! Но теперь он получается за специальную игровую валюту - поинты. Поинты - это вторая игровая валюта на нашем сервере. Один поинт равен 500 ₽CB (главной игровой валюты). Получаются поинты путём обмена валют у обменщика валют. Открыть меню обменщика можно командой /exchange. Обмен работает так: вы отдаёте 5000 ₽CB и взамен получаете сразу 10 поинтов. Далее, перед следующим обменом вам нужно подождать 1 минуту. Потом вы снова можете обменивать валюту.<br><br>Чтобы получить донат или кейс, вам нужно накопить достаточное количество поинтов. Количество зависит от вашей привилегии или кейса. Чтобы узнать цену, введите /donate. Откроется меню со всеми привилегиями и кейсами. Наводя курсор на иконки поочерёдно, найдите вашу привилегию. Сразу после названия привилегии/кейса вы должны увидить цену в поинтах. Далее вам нужно копить поинты, для этого вам нужно обменивать ₽CB на поинты. Для получения ₽CB, вы можете продавать блоки или предметы через /sell. Вы можете ознакомиться с командой /sell, введя /sell. Также вы можете проходить квесты. Для этого введите /quests и выполняйте задания. У админов все квесты всегда пройдены. Когда вы подзаработаете 5000 ₽CB, рекомендуем сразу обменивать их на поинты. Дело в том, что ₽CB не сохраняются после вайпа. Поэтому, если вы копите не привилегию, рекомендуем сразу обменивать все ₽CB, которые нужно обменять. Успевайте это делать до 25 числа (каждого месяца), т.к. в этот день у нас проходит вайп или обновление. Когда вы накопили нужное количество поинтов, то снова откройте меню с привилегиями, введя /donate. Найдите нужную вам привилегию и кликните по ней ПКМ. Нужное количество поинтов будет снято, а привилегия будет выдана. С кейсами всё точно также.</p>
<h3>ВНИМАНИЕ! ЕСЛИ ЧТО-ТО РАБОТАЕТ НЕ ТАК, НАПРИМЕР, НЕ ПРОИСХОДИТ ОБМЕН ВАЛЮТЫ ИЛИ НЕ ВЫДАЁТСЯ ПРИВИЛЕГИЯ, ТО ПОПРОБУЙТЕ ЗАЙТИ С 1.17.1. ТАМ ВСЁ ДОЛЖНО РАБОТАТЬ.</h3>
<br><br><br>
</center>
`
}
...
<p style="text-indent:1px">Тут мы представили наши обновления! Ниже их список и информация о них, обновления идут по порядку выхода:</p>
...
На этой версии сервера было мало плагинов и т.д., но сервер потихоньку улучшался.</p>

<h1>____________________</h1>

<p style="text-indent:1px">Майский вайп</p>
<p style="text-indent:1px">Майский вайп - это вайп-обновление, на котором была произведена отчистка карты, добавление NPC, а так-же добавлена поддержка бедрок-игроков и старых версий майнкрафт. Ещё на этом обновлении была проблема с сервером: Сервер стали постоянно ДДоСить, крашить, пытаться закрыть, из-за чего сервер постоянно отправлялся на режим технического обслуживания и изоляции, но потом всё утихло. Само обновление вышло 25.04.23. 25.05.23 вышло Летнее обновление.</p>

<h1>____________________</h1>

<p style="text-indent:1px">Летнее обновление</p>
<p style="text-indent:1px">Летнее обновление (или Июньское обновление) - это самое "тёплое" обновление в истории CraftBiped. На этом обновлении был изменён логотип сервера, а так-же: были добавлены донат-кейсы, обновлена PvP-арена, а так-же был обновлён наш дискорд-сервер. За 5 дней до лета был сделан /warp leto, на котором вы могли ждать лето вместе с другими игроками. За несколько дней до лета (29 мая) произошёл глобальный сбой хостинга, из-за чего сервер был закрыт на пару часов. Вышло обновление 25.05.23.</p>

<h1>____________________</h1>


<p style="text-indent:1px">Июльское обновление</p>
<p style="text-indent:1px">Июльское обновление - это обновление, на котором мы впервые сменили спавн! Теперь спавн гигантский, и имеет огромную PvP-арену. Ещё на этом обновлении произошёл инцидинет с глитчём, но он - выдумка. Вышло обновление 25.06.23.</p>
...
<p style="text-indent:1px">CraftBiped 3.0 (Осеннее обновление)</p>
<p style="text-indent:1px">CraftBiped 3.0 (или Осеннее обновление) - это обновление, где мы добавили новую валюту и не только! Вот список всего обновления:</p>

<p style="text-indent:1px">1 - Мы добавили поинты за которые можно купить очень интересные вещи! Купить поинты вы можете у обменщика валюты за игровую валюту! Всё это находится на /warp points!</p>

<p style="text-indent:1px">2 - Магазин перенесён на /warp shop!</p>

<p style="text-indent:1px">3 - Мы добавили красивый осенний текстурпак!</p>

<p style="text-indent:1px">4 - Мы изменили логотип</p>

<p style="text-indent:1px">5 - Провели вайп!</p>

<p style="text-indent:1px">6 - Добавили дуэли!</p>

<p style="text-indent:1px">Вышло обновление 25.08.23.</p>


<h1>____________________</h1>


<p style="text-indent:1px">Октябрьский вайп</p>
<p style="text-indent:1px">Октябрьский вайп - это обычный вайп, на котором мы ничего не добавили, но при этом он является частью Обновления 3.0. Вайп был проведён 25.09.23.</p>
...
<p style="text-indent:1px">Ноябрьский вайп</p>
<p style="text-indent:1px">Ноябрьский вайп - это обычный вайп, на котором мы так-же ничего не добавили, но с 25 октября по 1 ноября на сервере был Хэллоуинский спавн. Он так-же является частью Обновления 3.0. Вайп был проведён 25.10.23.</p>
...
<p style="text-indent:1px">CraftBiped 4.0 (Новогоднее обновление) </p>
<p style="text-indent:1px">CraftBiped 4.0 (Новогоднее обновление) - это текущее обновление. На нём мы добавили:</p>

<p style="text-indent:1px">1. Систему репортов. Нашли нарушителя? Киньте не него репорт! Для этого пропишите /report {Ник нарушителя} {Причина}. Не кидайте репорты просто так! После репорта рекомендуем отправить доказательства сюда в канал 🛑┇доказательства.</p>
...
<p style="text-indent:1px">3. Сменили логотип.</p>

<p style="text-indent:1px">4. Добавили секретную посхалку...</p>

<p style="text-indent:1px">Будующее: на Предновогоднем вайпе мы добавим возможность получения подарка!!! 5 Января возможность отключится.</p>
...
<p style="text-indent:1px">Февральский вайп - это часть обновления CraftBiped 4.0. Это самый обыкновенный вайп. Интересный факт: с 2024 года все обновления будут помечаться на конце "2024", чтобы их не спутали с обновлениями 2023 года. Вайп был проведён 25.01.2024!</p>

<h1>____________________</h1>
<p style="text-indent:1px">CraftBiped 5.0 (Весеннее обновление)</p>
<p style="text-indent:1px">CraftBiped 5.0 - это Первое обновление 2024 года, на котором CraftBiped исполнится 1 год, а так-же мы добавим следующие нововведения:<br>
1. Новые команды для всех: <br>
/stats <игрок> - позволяет просматривать статистику о игроке, который будет указан в аргументе.<br>
/help - команда, которая помогает ориентироваться на сервере, если вы новичок в Мультиплеере.<br>
2. Новые донатерские команды:<br>
/prefix <ваш кастомный префикс> - позволяет установить свой кастомный префикс. К этой команде есть дополнительная команда /delprex для удаления префикса. Команда доступна с Легенды.<br>
/bc <объявление> - позволяет сделать оповещение на весь сервер в чат. Доступно с Легенды, имеет кулдаун.<br>
/titlebc <объявление> - позволяет сделать оповещение всем игрокам на экран. Доступно с Легенды, имеет кулдаун.<br>
3. Новый спавн, PvP-арена и дуэли.<br>
4. Изменили логотип сервера.<br>
5. Изменили стиль сервера.<br>
6. Новая бонусная команда /spring, которая выдаёт бонусный набор и будет доступна до 25 мая.<br>
<p style="text-indent:1px">Обновление вышло 25.02.2024</p>
<h1>____________________</h1>
<p style="text-indent:1px">Апрельский вайп 2024</p>
<p style="text-indent:1px">Апрельский вайп 2024 - это часть обновления CraftBiped 5.0. Это самый обыкновенный вайп, на котором ничего не добавили, но карта была очищена.</p>
<p style="text-indent:1px">Вайп прошёл 25.03.2024</p>
<h1>____________________</h1>
<p style="text-indent:1px">Майский вайп 2024</p>
<p style="text-indent:1px">Майский вайп 2024 - это часть обновления CraftBiped 5.0. Это самый обыкновенный вайп, на котором ничего не добавили, но карта была очищена.</p>
...
<p>Желаем вам удачной игры на нашем сервере и с наступающим/наступившим новым годом!</p>
<p style="text-indent:1px">Вайп прошёл 25.12.2024</p>
<h1>____________________</h1>
<p style="text-indent:1px">Промежуточное обновление 22.01.2025</p>
<p>Это промежуточное обновление сервера, на котором мы снова сделали донаты бесплатными! Очистки карты не было.</p>
<p style="text-indent:1px">Обновление вышло 22.01.2025</p>
<h1>____________________</h1>
<p style="text-indent:1px">Февральский вайп 2025 (Текущее)</p>
<p>Встречайте! Самый первый вайп сервера CraftBiped в 2025 году!</p>
<p style="text-indent:1px">Февральский вайп 2025 - это часть обновления CraftBiped 7.0. Это самый обыкновенный вайп, на котором ничего не добавили, но карта была очищена.</p>
<p style="text-indent:1px">Вайп прошёл 25.01.2025</p>
<h1>____________________</h1>
</center>
`
}
