...
if (isFramed) {
          console.log('использование craftbiped.github.io во фреймах запрещено.');
          alert("Сайт craftbiped.github.io не будет открываться, чтобы защитить вас и проект CraftBiped! Сайт запущен внутри другого сайта!!!");
          window.location.href = "/saveyou.html"
} 
...
<div class="avtor-pravo"><h5 id="title">🍂 Осеннее оформление сайта 2025<br>© CraftBipedMC, 2023—2025</h5></div> <br>
`;
function openmenu(){
